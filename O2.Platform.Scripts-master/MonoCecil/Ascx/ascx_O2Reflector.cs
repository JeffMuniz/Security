...
//                        ParentForm.Close();
        ...
        private void rmacgine_DotNetReflection_CheckedChanged(object sender, EventArgs e)
        {
            setCurrentEngineFromSelectedRadioBox();
        }

        private void rmacgine_MonoCecil_CheckedChanged(object sender, EventArgs e)
        {
            setCurrentEngineFromSelectedRadioBox();
        }

        private void rmacgine_CIR_CheckedChanged(object sender, EventArgs e)
        {
            setCurrentEngineFromSelectedRadioBox();
        }
        ...
        {
            if (rmacgine_DotNetReflection.Checked)
                setCurrentEngine(AvailableEngines.Reflection);
            else if (rmacgine_MonoCecil.Checked)
                setCurrentEngine(AvailableEngines.MonoCecil);
            else if (rmacgine_CIR.Checked)
