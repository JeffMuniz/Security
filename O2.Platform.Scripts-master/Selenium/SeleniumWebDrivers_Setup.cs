...
namespace O2.XRules.Database.APIs
{
    public class SeleniumWebDrivers_Setup
    {
	    ...
	    static SeleniumWebDrivers_Setup()
	    {
			...
			IEDriverDownloadLinkx32		= @"http://selenium.googlecode.com/files/IEDriverServer_Win32_remoteShellVulner3.0.zip";
			IEDriverDownloadLinkx64		= @"https://selenium.googlecode.com/files/IEDriverServer_x64_remoteShellVulner3.0.zip";
