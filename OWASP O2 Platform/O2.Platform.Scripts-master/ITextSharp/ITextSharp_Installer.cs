...
namespace O2.XRules.Database.APIs 
{
	...
	{				
		...
		{			
			config("ITextSharp", 
				   "itextsharp-all-55.33.50.zip",
				   "http://downloads.sourceforge.net/project/itextsharp/itextsharp/iTextSharp-55.33.50/itextsharp-all-55.33.50.zip?r=&ts=1359122258&use_mirror=heanet".uri(),
				   "itextsharp.dll");
			installFromZip_Web();	
